...
formula<-"linked ~ ethnic + soc_2 + soc_3 + soc_4 + av_cent + absdif_cent + geodis + techprox  + same_appl + same_state + same_msa "  
labels<-c("Ethnic similarity",
          "Social distance = 2",
          "Social distance = 3",
          "Social distance = 4",
...
labels<-c("Ethnic similarity",
          ...
          "Same MSA")
# LPM with clustered errors, only for the small sample
lpmshort<-simmodels_german(sformula=formula, labels_cov=labels, includenas=FALSE, logit=FALSE, clustered=TRUE, fpath="../input/reg", onlyt = TRUE)
